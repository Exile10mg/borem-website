...
export const metadata: Metadata = {
  ...
  description: 'Strona reklamowa Borem.pl - Landing Page 1',
      ...
      <div className="max-w-4xl w-full relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-xl text-gray-300 font-semibold mb-6">
            która <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-blue-300 to-purple-400 font-black">zwiększa sprzedaż</span> i buduje zaufanie
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-gray-700 transition-all duration-300 hover:shadow-xl">
            <div className="text-center mb-5">
              <h3 className="text-xl font-bold text-white mb-3">Strona Firmowa</h3>
              <div className="text-4xl font-black text-white mb-2">2999 zł</div>
              <p className="text-sm text-gray-500">2-3 tygodnie</p>
            </div>
          ...
          <div className="relative">
            ...
            <div className="bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 rounded-xl p-6 shadow-2xl shadow-purple-500/20">
              <div className="text-center mb-5">
                <h3 className="text-xl font-bold text-white mb-3">Strona Advanced</h3>
                <div className="flex items-center justify-center gap-2 mb-2">
                  <span className="text-lg text-white/60 line-through">7999</span>
                  <span className="text-4xl font-black text-white">5999 zł</span>
                </div>
                <p className="text-sm text-blue-100 font-semibold">4-6 tygodni</p>
              </div>
              <ul className="space-y-3">
                {[
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-gray-700 transition-all duration-300 hover:shadow-xl">
            <div className="text-center mb-5">
              ...
              <div className="text-4xl font-black text-white mb-2">8999 zł</div>
              <p className="text-sm text-gray-500">Sklep online</p>
            </div>
            <ul className="space-y-3">
              {[
                'Sklep WooCommerce',
        ...
        <div className="grid grid-cols-4 gap-3 mb-6">
          {[
            { icon: faChartLine, value: '+250%', label: 'Wzrost', color: 'text-green-400', bg: 'from-green-500/10 to-green-500/5', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=300&h=200&fit=crop' },
            { icon: faRocket, value: '<2s', label: 'Ładowanie', color: 'text-blue-400', bg: 'from-blue-500/10 to-blue-500/5', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=300&h=200&fit=crop' },
            { icon: faBullseye, value: 'TOP 3', label: 'Google', color: 'text-purple-400', bg: 'from-purple-500/10 to-purple-500/5', image: 'https://images.unsplash.com/photo-1573164713714-d95e436ab8d6?w=300&h=200&fit=crop' },
            { icon: faShieldHalved, value: '98%', label: 'Satysfakcja', color: 'text-yellow-400', bg: 'from-yellow-500/10 to-yellow-500/5', image: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=300&h=200&fit=crop' },
          ].map((stat, i) => (
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className="relative bg-gradient-to-br from-gray-900 to-gray-900/50 border border-gray-800 rounded-xl p-6 hover:border-yellow-500/20 transition-all duration-300 overflow-hidden">
            ...
            <p className="text-gray-300 text-sm italic leading-relaxed mb-3">
              "+250% ruchu, +85% konwersji. Strona zwróciła się 10x w 6 miesięcy!"
            </p>
          ...
          <div className="relative bg-gradient-to-br from-gray-900 via-gray-900 to-blue-900/20 border border-gray-800 rounded-xl p-6 flex items-center justify-center hover:border-blue-500/30 transition-all duration-300 overflow-hidden">
            ...
            <div className="text-center relative z-10">
              <div className="text-3xl font-black text-white mb-2">START ZA 7 DNI</div>
              <p className="text-gray-400 text-sm mb-3">30 dni wsparcia GRATIS</p>
