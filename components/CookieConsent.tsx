...
export default function CookieConsent() {
  ...
  return (
    <>
      ...
      {showBanner && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[10000] transition-opacity duration-300" />
      )}

      {/* Cookie Banner */}
      {showBanner && (
        <div className="fixed bottom-0 left-0 right-0 z-[10001] mx-auto max-w-7xl p-2 sm:p-4 md:p-6 transition-all duration-500">
