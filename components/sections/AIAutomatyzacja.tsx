    ...
    <section id="ai" className="relative py-20 sm:py-24 lg:py-32 bg-gradient-to-b from-black via-gray-900 to-black text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-20">
        ...
        <div className="text-center mb-20 lg:mb-28">
          <div className="inline-block mb-6">
            <span className="px-5 py-2.5 rounded-full bg-gradient-to-r from-purple-500/20 via-pink-500/20 to-purple-500/20 border border-purple-500/30 text-purple-400 text-sm font-bold backdrop-blur-xl shadow-lg shadow-purple-500/10">
              <FontAwesomeIcon icon={faRobot} className="mr-2" fixedWidth />
              AI & Automatyzacja
            </span>
          </div>
        ...
        <div className="mb-20 lg:mb-32">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {aiSolutions.map((solution) => (
              ...
              >
                <div className={`absolute -inset-1 bg-gradient-to-r ${solution.gradient} opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-300 rounded-2xl`} />

                <div className={`relative h-full bg-gradient-to-br ${solution.bgGradient} backdrop-blur-xl border border-white/10 rounded-2xl p-6 sm:p-8 transition-all duration-300 hover:border-white/20`}>
                  <div className="flex items-start gap-4 mb-4">
                    <div className={`flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br ${solution.gradient} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                      <FontAwesomeIcon
                        icon={solution.icon}
        ...
        <div className="text-center">
          ...
          <a
            href="#kontakt"
            className="inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 text-white rounded-full font-bold text-lg shadow-2xl hover:shadow-purple-500/50 hover:scale-105 hover:-translate-y-1 transition-all relative overflow-hidden group"
          >
