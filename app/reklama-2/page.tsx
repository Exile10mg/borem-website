...
export default function Reklama2Page() {
  return (
      ...
      <div className="max-w-4xl w-full relative z-10">
        ...
        <div className="text-center mb-10">
          <h1 className="text-5xl md:text-6xl font-black text-white mb-4 leading-tight drop-shadow-2xl">
            Profesjonalny Sklep Online
          </h1>

          <p className="text-xl text-gray-300 font-semibold mb-6">
            który <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-blue-300 to-purple-400 font-black">generuje sprzedaż 24/7</span> automatycznie
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-gray-700 transition-all duration-300 hover:shadow-xl">
            <div className="text-center mb-5">
              <h3 className="text-xl font-bold text-white mb-3">Sklep Start</h3>
              <div className="text-4xl font-black text-white mb-2">4999 zł</div>
              <p className="text-sm text-gray-500">3-4 tygodnie</p>
            </div>
          ...
          <div className="relative">
            ...
            <div className="bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 rounded-xl p-6 shadow-2xl shadow-purple-500/20">
              <div className="text-center mb-5">
                <h3 className="text-xl font-bold text-white mb-3">Sklep Business</h3>
                <div className="flex items-center justify-center gap-2 mb-2">
                  <span className="text-lg text-white/60 line-through">11999</span>
                  <span className="text-4xl font-black text-white">8999 zł</span>
                </div>
                <p className="text-sm text-blue-100 font-semibold">5-7 tygodni</p>
              </div>
              <ul className="space-y-3">
                {[
                  'Do 200 produktów',
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-gray-700 transition-all duration-300 hover:shadow-xl">
            <div className="text-center mb-5">
              <h3 className="text-xl font-bold text-white mb-3">Sklep Enterprise</h3>
              <div className="text-4xl font-black text-white mb-2">14999 zł</div>
              <p className="text-sm text-gray-500">8-12 tygodni</p>
            </div>
            <ul className="space-y-3">
              {[
        ...
        <div className="grid grid-cols-4 gap-3 mb-6">
          {[
            { icon: faChartLine, value: '+340%', label: 'Sprzedaż', color: 'text-green-400', bg: 'from-green-500/10 to-green-500/5', image: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=300&h=200&fit=crop' },
            { icon: faRocket, value: '24/7', label: 'Otwarte', color: 'text-blue-400', bg: 'from-blue-500/10 to-blue-500/5', image: 'https://images.unsplash.com/photo-1472851294608-062f824d29cc?w=300&h=200&fit=crop' },
            { icon: faBullseye, value: '18%', label: 'Konwersja', color: 'text-purple-400', bg: 'from-purple-500/10 to-purple-500/5', image: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=300&h=200&fit=crop' },
            { icon: faShieldHalved, value: 'ROI 10x', label: 'Zwrot', color: 'text-yellow-400', bg: 'from-yellow-500/10 to-yellow-500/5', image: 'https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?w=300&h=200&fit=crop' },
          ].map((stat, i) => (
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className="relative bg-gradient-to-br from-gray-900 to-gray-900/50 border border-gray-800 rounded-xl p-6 hover:border-yellow-500/20 transition-all duration-300 overflow-hidden">
            ...
            <p className="text-gray-300 text-sm italic leading-relaxed mb-3">
              "44 tys. zł przychodu przy 4 tys. zł budżecie. ROI 1000%!"
            </p>
            <p className="text-gray-500 text-xs font-semibold">— E-DAKRO</p>
          </div>
          ...
          <div className="relative bg-gradient-to-br from-gray-900 via-gray-900 to-blue-900/20 border border-gray-800 rounded-xl p-6 flex items-center justify-center hover:border-blue-500/30 transition-all duration-300 overflow-hidden">
            ...
            <div className="text-center relative z-10">
              <div className="text-3xl font-black text-white mb-2">PIERWSZY PRZYCHÓD</div>
              <p className="text-gray-400 text-sm mb-3">w 1. tygodniu działania</p>
