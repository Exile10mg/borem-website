    ...
    <>
      ...
      {!prefersReducedMotion && (
        <>
          ...
          />
          <motion.div
            className="absolute bottom-1/4 left-1/3 w-[500px] h-[500px] rounded-full opacity-10 blur-[120px]"
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <motion.div
                className="flex items-center gap-4 p-6 bg-gradient-to-br from-white/10 to-white/[0.02] backdrop-blur-xl border border-white/10 rounded-2xl"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
