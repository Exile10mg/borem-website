...
const Navbar = memo(function Navbar() {
  ...
  useEffect(() => {
    ...
    // Use passive: false for better scroll response
  ...
  return (
    <nav
      className={`fixed top-0 w-full z-[60] transition-all duration-200 ${
        isScrolled
          ? 'backdrop-blur-2xl shadow-2xl shadow-purple-500/20'
          : ''
      }`}
    >
        ...
        >
          ...
          {/* Extra solid overlay for better contrast */}
        ...
        <div className="relative z-50 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Link href="/" className="flex items-center gap-2 sm:gap-3 group relative z-[100]">
            ...
            <div className="relative z-[110]">
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-[18px] opacity-75 group-hover:opacity-100 blur-sm transition-all duration-300 animate-gradient bg-[length:200%_200%]"></div>
            ...
            <div>
              <div className="flex items-baseline gap-0.5">
                ...
                <span className="text-base sm:text-xl lg:text-2xl font-black bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent animate-gradient bg-[length:200%_200%]">.pl</span>
              </div>
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <div className="relative h-full overflow-y-auto flex flex-col touch-pan-y overscroll-contain">
              ...
              {/* Bottom CTAs */}
              <motion.div
                className="px-6 py-6 space-y-3 border-t border-white/10 bg-gradient-to-t from-black/50 to-transparent backdrop-blur-xl"
